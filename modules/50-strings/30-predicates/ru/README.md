...
Упомянутые функции сравнивают строки и строковые символы _буквально_ или, как говорят, _лексикографически_. Однако при работе с текстом часто нужно сопоставлять строки без _учёта регистра_, или производить _регистронезависимое сравнение_ (_case-insensitive comparison_). В Racket для каждой функции сравнения есть регистронезависимый вариант, имеющий суффикс `-ci` ("case-insensitive"):
