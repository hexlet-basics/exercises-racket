...
Всё, что дальше будет говориться про Racket, почти всегда справедливо и для остальных Lisp-языков. Да и сам Racket очень похож на другие диалекты Scheme (да, Racket — тоже диалект Scheme).
